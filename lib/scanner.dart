...
// Check initial connectivity status
    ...
    Connectivity().onConnectivityChanged.listen((List<ConnectivityResult> results) async {
      setState(() {
        isConnectedToInternet = results.isNotEmpty && results.first != ConnectivityResult.none;
      });
      ...
      body: Center(child: LayoutBuilder(
        ...
        return MobileScanner(
          ...
          onDetect: (barcodes) async {
            ...
            await fetchStudentAndEvent(output, _selectedEvent, isConnectedToInternet);
                    ...
                    child: GenericFormFields(
                      ...
                      onSubmit: (Map<String, String> formData) async {
                        try {
                          ...
                          // logger.i("Internet Connectivity: $isConnectedToInternet");
                          await fetchStudentAndEvent(
                              studentID!, _selectedEvent, isConnectedToInternet);
  ...
  Future<void> fetchStudentAndEvent(
      String studentID, String selectedEvent, bool isConnectedToInternet) async {
    // logger.i("Internet Connectivity When Fetching Student: $isConnectedToInternet");
    try {
      if (isConnectedToInternet) {
        // Online Mode
        ...
        if (student.docs.isNotEmpty && event.docs.isNotEmpty) {
          ...
          if (studentQueryDoc.data() != null && studentQueryDoc.data() is Map<String, dynamic>) {
            ...
            final student = Student(
              studentId: "12345",
              firstName: "John",
              lastName: "Doe", yearLevel: '1st Year',
            );
            ...
            await _offlineAttendanceService.cacheStudentData(student);
            await _offlineAttendanceService.cacheEventReference(eventDocRef.id, _selectedEvent);
            Fluttertoast.showToast(
              msg: firstName,
              toastLength: Toast.LENGTH_SHORT,
              gravity: ToastGravity.CENTER,
        ...
        logger.i("Cached Student: ${cachedStudent?.firstName}");

        if (cachedStudent != null) {
          // Save attendance record for later sync
          await _offlineAttendanceService.saveOfflineAttendance(
            cachedStudent,
            selectedEvent,
          );
          Fluttertoast.showToast(
            msg: "${cachedStudent.firstName} (Offline)",
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.CENTER,
            timeInSecForIosWeb: 1,
          ...
          Fluttertoast.showToast(
            msg: "Student not found, please connect to internet",
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.CENTER,
            timeInSecForIosWeb: 1,
            backgroundColor: Colors.red,
      ...
      Fluttertoast.showToast(
        msg: "Error processing attendance",
        toastLength: Toast.LENGTH_SHORT,
        gravity: ToastGravity.CENTER,
        timeInSecForIosWeb: 1,
        backgroundColor: Colors.red,
